...
return steam_inventory_result_get_status_raw(buffer_get_address(_buf), 4);
...
var _buf = steam_gml_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return steam_inventory_result_get_unix_timestamp_raw(buffer_get_address(_buf), 4);
...
return steam_inventory_result_get_item_property_raw(buffer_get_address(_buf), 9, argument2);
...
buffer_write(_buf, buffer_s32, argument0);
var __size__ = steam_inventory_result_get_items_raw(buffer_get_address(_buf), 8);
...
var _buf = steam_gml_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
return steam_inventory_result_destroy_raw(buffer_get_address(_buf), 4);
...
var _buf = steam_gml_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
if (steam_inventory_trigger_item_drop_raw(buffer_get_address(_buf), 4)) {
	buffer_seek(_buf, buffer_seek_start, 0);
...
var _buf = steam_gml_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
if (steam_inventory_add_promo_item_raw(buffer_get_address(_buf), 4)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
if (steam_inventory_add_promo_items_raw(buffer_get_address(_buf), 8)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
if (steam_inventory_consume_item_raw(buffer_get_address(_buf), 12)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
if (steam_gml_use_structs) {
	...
	buffer_write(_buf, buffer_u32, _len_0);
	for (var _ind_0 = 0; _ind_0 < _len_0; _ind_0++) {
		var _struct_1 = _arr_0[_ind_0]; // steam_inventory_itemdef_w_quantity
	...
	buffer_write(_buf, buffer_u32, _len_0);
	for (var _ind_0 = 0; _ind_0 < _len_0; _ind_0++) {
		var _struct_1 = _arr_0[_ind_0]; // steam_inventory_itemid_w_quantity
...
if (steam_inventory_exchange_items_raw(buffer_get_address(_buf), 16)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
if (steam_inventory_generate_items_raw(buffer_get_address(_buf), 8)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
return steam_inventory_request_eligible_promo_item_defs_raw(buffer_get_address(_buf), 9);
...
if (steam_inventory_get_items_by_id_raw(buffer_get_address(_buf), 8)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
var _buf = steam_gml_prepare_buffer(8);
if (steam_inventory_start_update_properties_raw(buffer_get_address(_buf), 8)) {
...
return steam_inventory_set_property_bool_raw(buffer_get_address(_buf), 18, argument2);
...
return steam_inventory_set_property_float_raw(buffer_get_address(_buf), 21, argument2);
...
return steam_inventory_set_property_int_raw(buffer_get_address(_buf), 25, argument2);
...
buffer_write(_buf, buffer_u64, argument0);
buffer_write(_buf, buffer_u64, argument1);
return steam_inventory_set_property_string_raw(buffer_get_address(_buf), 18, argument2, argument3);
...
buffer_write(_buf, buffer_u64, argument0);
buffer_write(_buf, buffer_u64, argument1);
return steam_inventory_remove_property_raw(buffer_get_address(_buf), 17, argument2);
...
var _buf = steam_gml_prepare_buffer(8);
buffer_write(_buf, buffer_u64, argument0);
if (steam_inventory_submit_update_properties_raw(buffer_get_address(_buf), 8)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
return steam_inventory_load_item_definitions_raw(buffer_get_address(_buf), 1);

#define steam_inventory_get_item_price
/// steam_inventory_get_item_price(item_def:steam_inventory_item_def)->int?
var _buf = steam_gml_prepare_buffer(9);
buffer_write(_buf, buffer_s32, argument0);
if (steam_inventory_get_item_price_raw(buffer_get_address(_buf), 9)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	var _val_0;
...
var _buf = steam_gml_prepare_buffer(9);
var __size__ = steam_inventory_get_items_with_prices_raw(buffer_get_address(_buf), 9);
if (__size__ == 0) return undefined;
if (__size__ <= 4) return [];
if (buffer_get_size(_buf) < __size__) buffer_resize(_buf, __size__);
...
var _buf = steam_gml_prepare_buffer(1);
return steam_inventory_request_prices_raw(buffer_get_address(_buf), 1);
...
if (steam_inventory_transfer_item_quantity_raw(buffer_get_address(_buf), 20)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	return buffer_read(_buf, buffer_s32);
} else return undefined;
...
var _buf = steam_gml_prepare_buffer(1);
return steam_lobby_send_chat_message_raw(buffer_get_address(_buf), 1, argument0);
...
return steam_lobby_send_chat_message_buffer_raw(buffer_get_address(_buf), 21);

#define steam_lobby_get_chat_message_data
/// steam_lobby_get_chat_message_data(message_index:int, buf:buffer)->bool
var _buf = steam_gml_prepare_buffer(24);
buffer_write(_buf, buffer_u64, argument0);
...
return steam_lobby_get_chat_message_data_raw(buffer_get_address(_buf), 24);

#define steam_lobby_set_joinable
/// steam_lobby_set_joinable(joinable:bool)->bool
var _buf = steam_gml_prepare_buffer(1);
buffer_write(_buf, buffer_bool, argument0);
return steam_lobby_set_joinable_raw(buffer_get_address(_buf), 1);

#define steam_get_friends_game_info
/// steam_get_friends_game_info()->array<any>
var _buf = steam_gml_prepare_buffer(8);
var __size__ = steam_get_friends_game_info_raw(buffer_get_address(_buf), 8);
if (__size__ == 0) return undefined;
if (__size__ <= 4) return [];
if (buffer_get_size(_buf) < __size__) buffer_resize(_buf, __size__);
...
var _buf = steam_gml_prepare_buffer(8);
buffer_write(_buf, buffer_u64, argument0);
return steam_get_user_persona_name_sync_raw(buffer_get_address(_buf), 8);
...
buffer_write(_buf, buffer_u64, argument0);
buffer_write(_buf, buffer_s32, argument1);
return steam_get_user_avatar_raw(buffer_get_address(_buf), 12);

#define steam_image_get_size
/// steam_image_get_size(img:int)->
var _buf = steam_gml_prepare_buffer(9);
buffer_write(_buf, buffer_s32, argument0);
if (steam_image_get_size_raw(buffer_get_address(_buf), 9)) {
	buffer_seek(_buf, buffer_seek_start, 0);
	var _val_0;
	if (buffer_read(_buf, buffer_bool)) {
...
return steam_image_get_rgba_raw(buffer_get_address(_buf), 20);
...
return steam_image_get_bgra_raw(buffer_get_address(_buf), 20);
